...
public class BuildStudyDatabaseCommand extends BaseCommand {
    ...
    /**
     * Human-readable build request identifier generated by service layer
     * Ensures consistent correlation between command, event, and read model
     */
    @NotNull(message = "Build request ID is required")
    @Size(min = 5, max = 100, message = "Build request ID must be between 5 and 100 characters")

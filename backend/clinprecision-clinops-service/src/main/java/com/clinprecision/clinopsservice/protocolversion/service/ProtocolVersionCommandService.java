...
public class ProtocolVersionCommandService {
    ...
    public CompletableFuture<Void> approveVersion(ApproveVersionCommand command) {
        ...
        validationService.validateStatusChange(command.getVersionId(), com.clinprecision.clinopsservice.protocolversion.domain.valueobjects.VersionStatus.APPROVED);
    ...
    public CompletableFuture<Void> activateVersion(ActivateVersionCommand command) {
        ...
        validationService.validateStatusChange(command.getVersionId(), com.clinprecision.clinopsservice.protocolversion.domain.valueobjects.VersionStatus.ACTIVE);
    ...
    public CompletableFuture<Void> withdrawVersion(WithdrawVersionCommand command) {
        ...
        validationService.validateStatusChange(command.getVersionId(), com.clinprecision.clinopsservice.protocolversion.domain.valueobjects.VersionStatus.WITHDRAWN);

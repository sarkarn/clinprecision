...
import com.clinprecision.clinopsservice.studydesign.design.repository.StudyDesignReadRepository;
...
public class StudyDesignProjection {
    ...
    private final StudyDesignReadRepository studyRepository;

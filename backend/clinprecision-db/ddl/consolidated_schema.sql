...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stores all domain events for event sourcing';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Stores aggregate snapshots for performance';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Saga event associations';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Event processor tracking tokens';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Saga instance storage';

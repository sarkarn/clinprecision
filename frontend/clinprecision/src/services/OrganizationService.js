...
export const OrganizationService = {
  ...
  getAllOrganizations: async () => {
    try {
      const response = await ApiService.get('/users-ws/organizations');
  ...
  getOrganizationById: async (id) => {
    try {
      const response = await ApiService.get(`/users-ws/organizations/${id}`);
      return response.data;
    } catch (error) {
  ...
  createOrganization: async (organizationData) => {
    try {
      const response = await ApiService.post('/users-ws/organizations', organizationData);
      return response.data;
    } catch (error) {
  ...
  updateOrganization: async (id, organizationData) => {
    try {
      const response = await ApiService.put(`/users-ws/organizations/${id}`, organizationData);
      return response.data;
    } catch (error) {
  ...
  deleteOrganization: async (id) => {
    try {
      const response = await ApiService.delete(`/users-ws/organizations/${id}`);
      return response.data;
    } catch (error) {
  ...
  addOrganizationContact: async (organizationId, contactData) => {
    try {
      const response = await ApiService.post(`/users-ws/organizations/${organizationId}/contacts`, contactData);
      return response.data;
    } catch (error) {
  ...
  updateOrganizationContact: async (organizationId, contactId, contactData) => {
    try {
      const response = await ApiService.put(`/users-ws/organizations/${organizationId}/contacts/${contactId}`, contactData);
      return response.data;
    } catch (error) {
  ...
  deleteOrganizationContact: async (organizationId, contactId) => {
    try {
      const response = await ApiService.delete(`/users-ws/organizations/${organizationId}/contacts/${contactId}`);
      return response.data;
    } catch (error) {
  ...
  getOrganizationContacts: async (organizationId) => {
    try {
      const response = await ApiService.get(`/users-ws/organizations/${organizationId}/contacts`);
      return response.data;
    } catch (error) {

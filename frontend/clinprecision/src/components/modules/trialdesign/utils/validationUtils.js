...
export const clinicalValidationRules = {
    ...
    protocolNumber: {
        ...
        suggestions: (currentValue, formData) => {
...
export const validationHelpers = {
     ...
     */
    isValidStudyDate: (dateString, minDate = null, maxDate = null) => {
     ...
     */
    validateProtocolNumber: async (protocolNumber, existingProtocols = []) => {
     ...
     */
    generateSmartSuggestions: (fieldName, currentValue, formData) => {
        switch (fieldName) {
            case 'protocolNumber':
     ...
     */
    calculateFormReadiness: (formData, validationRules) => {
...
const generateProtocolSuggestions = (formData) => {
    const year = new Date().getFullYear();
...
const generateStudyNameSuggestions = (formData) => {

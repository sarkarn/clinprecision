 ...
 * @param {number} context.patientId - Patient database ID (required)
 * @param {number} context.studySiteId - Study-site relationship ID (required)
 * @param {number} context.visitId - Visit ID (optional)
 * @param {string} context.patientName - Patient display name
 * @param {string} context.studyName - Study name
 * @param {string} context.visitName - Visit name
 * @param {string} context.reportedBy - Current user
 * @param {function} onDeviationCreated - Success callback
 */
export default function DeviationModal({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await ProtocolDeviationService.createDeviation(deviationData);

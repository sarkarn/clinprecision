...
import { ArrowLeft, Users, Calendar, FileText, CheckCircle, Clock, LucideIcon } from 'lucide-react';
 ...
 */
const StudyContextHeader: FC<StudyContextHeaderProps> = ({
  study,
  currentPage,
  onBack,
  showProgress = false,
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                ...
                {study?.studyPhase && (
                  <span className="flex items-center">
                    ...
                    {typeof study.studyPhase === 'string' ? study.studyPhase : study.studyPhase.name}
                  </span>
                )}

...
import { ArrowLeft, Home, Menu, X, LucideIcon } from 'lucide-react';
...
const NavigationSidebar: FC<NavigationSidebarProps> = ({
  ...
  const getQuickActions = (): QuickAction[] => {
    ...
    if (inStudyContext && study && context?.studyId) {
      actions.unshift({
 ...
 */
export const NavigationToggle: FC<NavigationToggleProps> = ({ onClick, isOpen }) => (
  <button
    onClick={onClick}

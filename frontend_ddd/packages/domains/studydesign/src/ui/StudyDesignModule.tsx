...
import TopNavigationHeader from '../../../../ui-kit/src/TopNavigationHeader';
...
import FormVersionHistory from './forms/FormVersionHistory';
import FormVersionViewer from './forms/FormVersionViewer';
import CRFBuilderIntegration from './forms/CRFBuilderIntegration';
...
const Breadcrumb: React.FC = () => {
    ...
    const breadcrumbs: BreadcrumbItem[] = getBreadcrumbInfo();
...
const StudyDesignModule: React.FC = () => {
    const navigate = useNavigate();
    ...
    const [selectedStudyForVersion, setSelectedStudyForVersion] = useState<any>(null);
    ...
    const isStudySpecificContext = (): boolean => {
        ...
        <div className={isDirectNavigation ? "min-h-screen flex flex-col" : ""}>
            ...
            <div className={`container mx-auto px-4 pb-4 flex-1 ${isDirectNavigation ? "mt-16" : isEmbeddedInHome ? "pt-0" : "pt-4"}`}>
                ...
                <Routes>
                    ...
                    <Route path="create/*" element={<StudyCreationWizard />} />
                    ...
                    {/* FormDesigner routes commented out - file is empty */}

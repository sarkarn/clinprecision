...
interface NextStep {
  type: 'complete_current' | 'next_phase' | 'complete';
  phase?: Phase;
  message: string;
  action: string;
}
 ...
 */
const WorkflowProgressTracker: FC<WorkflowProgressTrackerProps> = ({
  phases,
  currentPhase,
  completedPhases,
  designProgress,
  ...
  const validatePhase = (phaseId: string): ValidationResult => {
          ...
          <div className="bg-blue-50 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-grow">
                ...
                {nextStep.type === 'next_phase' && nextStep.phase && (
                  <button

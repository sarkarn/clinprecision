// StudyTeamManagement.tsx
// ...file content omitted for brevity (see previous tool result)...

import React, { useState, useEffect, ChangeEvent, FormEvent } from 'react';
import { useParams, Link } from 'react-router-dom';
import { UserStudyRoleService, UserService, RoleService } from '@domains/identity-access';
import type { Study } from '@shared/types';
import type { StudyTeamMember, User, Role } from '@shared/types';
// NewMemberForm is a type declared as interface in user.types.ts, so:
import type { NewMemberForm } from '@shared/types';
...
const StudyTeamManagement: React.FC = () => {
    ...
    const [teamMembers, setTeamMembers] = useState<StudyTeamMember[]>([]);
    ...
    const getFilteredTeamMembers = (): StudyTeamMember[] => {

...
const OrganizationForm: React.FC = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				...
				if (isEditMode && id) {
					const orgData = (await OrganizationService.getOrganizationById(id)) as any;
					setFormData({
						name: orgData.name || '',
	...
	const handleSubmit = async (e: FormEvent) => {
		...
		try {
			...
			if (isEditMode && id) {
				await OrganizationService.updateOrganization(id, organizationData as any);
			} else {
	...
	return (
		<div className="max-w-3xl mx-auto">
			<div className="mb-6">
				<h3 className="text-xl font-semibold">{isEditMode ? 'Edit Organization' : 'Create Organization'}</h3>
				<p className="text-gray-600 mt-1">
					{isEditMode ? 'Update organization details' : 'Enter information to create a new organization'}
				</p>
			</div>
			...
			{loading && !formData.name ? (
				...
				<form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
					<div className="mb-6">
						<h4 className="text-lg font-medium text-gray-800 mb-4 pb-2 border-b border-gray-200">Organization Information</h4>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div>
								...
								<input
									...
									className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
								/>
								<p className="text-xs text-gray-500 mt-1">External identifier for reference (e.g., DUNS number)</p>
							</div>
							<div>
					...
					<div className="mb-6">
						<h4 className="text-lg font-medium text-gray-800 mb-4 pb-2 border-b border-gray-200">Address</h4>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="md:col-span-2">
